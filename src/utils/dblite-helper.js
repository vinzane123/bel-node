...
module.exports.connect = function (connectString, cb) {
  ...
  var sql = [
    ...
    //"CREATE TABLE IF NOT EXISTS merchant(countryCode VARCHAR(2) NOT NULL, transactionId VARCHAR(20) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
