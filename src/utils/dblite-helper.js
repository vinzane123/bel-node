...
module.exports.connect = function (connectString, cb) {
  ...
  var sql = [
    ...
    "CREATE TABLE IF NOT EXISTS ac_status(status VARCHAR(20) NOT NULL, expDate VARCHAR(20) NOT NULL, transactionId VARCHAR(20) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
    ...
    "CREATE TABLE IF NOT EXISTS merchant(countryCode varchar(2), payFor VARCHAR(68) NOT NULL, transactionId VARCHAR(20) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
    ...
    "CREATE TABLE IF NOT EXISTS verifiers(verifierName VARCHAR(20) NOT NULL, transactionId VARCHAR(64) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
