module.exports = {
  ...
  MERCHANT_TRS: 20, // MERCHANT TRANSFER FOR DOCUMENT VERIFICATION OF USER
  MERCHANT: 21, // BECOME MERCHANT
  VERIFIER: 22, // BECOME VERIFIRE
  ENABLE_WALLET_KYC_BY_MERCHANT: 23, // ENABLE KYC WALLET OF USER BY MERCHANT 
